...
<head>
    ...
    <title>Grupo Morami| Registro de pedidos </title>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="public/dist/img/user4-128x128.jpg" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Asesor de ventas</a>
                    </div>
                </div>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Registro de nuevos pedidos</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Registro de nuevos pedidos</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name=" apellidoM" placeholder="Ingresa apellido materno">
                                </div>

                                <div class="form-group">
                                    <label>Dirección</label>
                                    <input type="text" class="form-control" name="direccion" placeholder="Ingresa dirección del cliente">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="municipio" placeholder="Ingresa municipio del cliente">
                                </div>

                                <div class="form-group">
                                    <label>Vendedor</label>
                                    <input type="text" class="form-control" name="vendedor" placeholder="Ingresa nombre del vendedor">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tel" placeholder="Ingresa telefono del cliente">
                                </div>
                            </div>
                        </div><br>
                        ...
                        <section class="content">
                            <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <td>
                                                <button type="button" class="bg-gradient-warning btn-sm">Agregar producto</button>
                                            </td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-success">Guardar pedido</button>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-success">
                                                ...
                                                <div class="modal-body">
                                                    <p>El pedido se ha guardado con éxito</p>
                                                </div>
                                ...
                                <script>
                                    $(function() {
                                        $('#fechaCaducidadPicker').datetimepicker({
                                            format: 'L' // formato de fecha (día/mes/año)
                                        });
                                    });
                                </script>
                                ...
                                <script>
                                    document.getElementById("unidadMedida").addEventListener("change", function() {
                                        ...
                                        var formato = document.getElementById("formatoMedida");
